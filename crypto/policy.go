//go:generate mockgen -destination=mocks/mock_signature_policy.go -package=mocks github.com/IPFS-eX/carrier/crypto SignaturePolicy
//go:generate mockgen -destination=mocks/mock_hash_policy.go -package=mocks github.com/IPFS-eX/carrier/crypto HashPolicy
